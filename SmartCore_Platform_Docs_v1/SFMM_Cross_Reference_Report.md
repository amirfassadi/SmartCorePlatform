...
|---|---|---|---|---|
| [030_SmartCore_Core_Vocabulary.md](030_SmartCore_Core_Vocabulary.md) | “Level 0 (Reference)” | 005_SmartCore_Semantic_Grammar.md | Broken | The referenced file does not exist in the current documentation set. |
...
| [032_SmartCore_Execution_Boundary_Model.md](032_SmartCore_Execution_Boundary_Model.md) | Section 2 | Core Semantic Model / Domain Model / Runtime Execution / Infrastructure | Indirect | The document introduces a distinct layer model but does not link it to the SFMM layer definitions. |
