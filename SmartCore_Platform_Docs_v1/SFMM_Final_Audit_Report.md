...
- “Capability” is used as a semantic concept in [042_SmartCore_Capability_Model.md](042_SmartCore_Capability_Model.md) and as an architectural/platform concept in [047_SmartCore_Reference_Architecture.md](047_SmartCore_Reference_Architecture.md), [047_SmartCore_Architecture& Taxonomy_Layer_Model.md](047_SmartCore_Architecture&%20Taxonomy_Layer_Model.md), and [049_SmartCore_Platform_Taxonomy.md](049_SmartCore_Platform_Taxonomy.md).
- “Domain” is used in at least three ways: as a semantic modeling layer in [005_SmartCore_Domain_Layer.md](005_SmartCore_Domain_Layer.md), as an architectural layer in [047_SmartCore_Reference_Architecture.md](047_SmartCore_Reference_Architecture.md), and as a business-area concept in [032_SmartCore_Domain_Modeling_Rules.md](032_SmartCore_Domain_Modeling_Rules.md).
- “Solution” is present as a composition concept in [047_SmartCore_Reference_Architecture.md](047_SmartCore_Reference_Architecture.md) and [047_SmartCore_Architecture& Taxonomy_Layer_Model.md](047_SmartCore_Architecture&%20Taxonomy_Layer_Model.md), but it is not clearly distinguished from “Application” in the broader package.
- “Identity” is defined semantically in [046_SmartCore_Semantic_Glossary.md](046_SmartCore_Semantic_Glossary.md) and also treated as a platform concern in [019_SmartCore_Identity_and_Session_Continuity_Model.md](019_SmartCore_Identity_and_Session_Continuity_Model.md).
...
- [046_SmartCore_Semantic_Glossary.md](046_SmartCore_Semantic_Glossary.md) treats Capability as a derived construct.
- [049_SmartCore_Platform_Taxonomy.md](049_SmartCore_Platform_Taxonomy.md) introduces Platform Capability as a distinct architectural concept.
...
- [046_SmartCore_Semantic_Glossary.md](046_SmartCore_Semantic_Glossary.md) defines semantic responsibilities.
...
- [049_SmartCore_Platform_Taxonomy.md](049_SmartCore_Platform_Taxonomy.md) assigns responsibilities to platform families and modules.
...
- [033_SmartCore_Execution_Boundary_Model.md](033_SmartCore_Execution_Boundary_Model.md) uses a four-layer execution boundary model: Core Semantic Model, Domain Model, Runtime Execution, and Infrastructure.
- [047_SmartCore_Reference_Architecture.md](047_SmartCore_Reference_Architecture.md) defines six layers: Foundation, Core Engines, Capability Platforms, Domain Models, Solutions, and Developer Platform.
...
The platform taxonomy is defined in [049_SmartCore_Platform_Taxonomy.md](049_SmartCore_Platform_Taxonomy.md), but it is not fully aligned with the reference architecture or the layer model.

- [047_SmartCore_Reference_Architecture.md](047_SmartCore_Reference_Architecture.md) uses the term “Capability Platforms” as a layer.
- [049_SmartCore_Platform_Taxonomy.md](049_SmartCore_Platform_Taxonomy.md) uses “Platform Families” and “Platform Modules” as taxonomy concepts.

The relationship between the layer and the taxonomy is not fully explicit.

### 4.3 Governance

Governance is documented in [051_SmartCore_Governance_and_Decision_Model.md](051_SmartCore_Governance_and_Decision_Model.md), but its relationship to the root README, the ADRs, and the architecture documents is not fully unified.

- The root [README.md](README.md) describes a layered architecture and references documents 046–051.
- [051_SmartCore_Governance_and_Decision_Model.md](051_SmartCore_Governance_and_Decision_Model.md) defines governance rules for architecture changes and freezes.
...
- [047_SmartCore_Reference_Architecture.md](047_SmartCore_Reference_Architecture.md) presents a one-way dependency from foundation to developer platform.
...
- [031_SmartCore_Core_Vocabulary.md](031_SmartCore_Core_Vocabulary.md) references a missing document named “005_SmartCore_Semantic_Grammar.md”.
...
- Platform capability and semantic capability are both discussed in overlapping language in [049_SmartCore_Platform_Taxonomy.md](049_SmartCore_Platform_Taxonomy.md) and [042_SmartCore_Capability_Model.md](042_SmartCore_Capability_Model.md).

### 6.2 Contradictory Wording

The package contains some contradictory or at least competing wording:

- the README describes 046–050 as architecture documents, while [047_SmartCore_Reference_Architecture.md](047_SmartCore_Reference_Architecture.md) also uses the title “Platform Architecture” and [047_SmartCore_Architecture& Taxonomy_Layer_Model.md](047_SmartCore_Architecture&%20Taxonomy_Layer_Model.md) uses the phrase “canonical layer model”.
- [047_SmartCore_Reference_Architecture.md](047_SmartCore_Reference_Architecture.md) and [047_SmartCore_Architecture& Taxonomy_Layer_Model.md](047_SmartCore_Architecture&%20Taxonomy_Layer_Model.md) both claim to define the architecture structure, but their scopes differ.
...
- [051_SmartCore_Governance_and_Decision_Model.md](051_SmartCore_Governance_and_Decision_Model.md) establishes a freeze policy and decision levels.
...
- [047_SmartCore_Reference_Architecture.md](047_SmartCore_Reference_Architecture.md) defines a reference architecture.
...
- [049_SmartCore_Platform_Taxonomy.md](049_SmartCore_Platform_Taxonomy.md) defines platform taxonomy.
- [050_SmartCore_Module_Standards.md](050_SmartCore_Module_Standards.md) defines module standards.
- [051_SmartCore_Governance_and_Decision_Model.md](051_SmartCore_Governance_and_Decision_Model.md) defines governance and freeze policy.
- [052_SmartCore_Development_Roadmap.md](052_SmartCore_Development_Roadmap.md) defines roadmap sequencing.
...
[052_SmartCore_Development_Roadmap.md](052_SmartCore_Development_Roadmap.md) is broadly consistent with the architecture narrative, but it relies on the same unresolved concepts.
...
- Missing or broken references in [031_SmartCore_Core_Vocabulary.md](031_SmartCore_Core_Vocabulary.md) and [016_SmartCore_Production_Deployment_and_Scaling_Model.md](016_SmartCore_Production_Deployment_and_Scaling_Model.md).
- Lack of one authoritative layer definition across [001_SmartCore_Foundational_Principles.md](001_SmartCore_Foundational_Principles.md), [033_SmartCore_Execution_Boundary_Model.md](033_SmartCore_Execution_Boundary_Model.md), [047_SmartCore_Reference_Architecture.md](047_SmartCore_Reference_Architecture.md), and [047_SmartCore_Architecture& Taxonomy_Layer_Model.md](047_SmartCore_Architecture&%20Taxonomy_Layer_Model.md).
